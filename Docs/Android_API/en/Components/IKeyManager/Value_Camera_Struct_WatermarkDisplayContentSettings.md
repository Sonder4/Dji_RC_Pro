**Navigation:** [IKeyManager](IKeyManager.md) > [DJIValue](DJIValue.md) > [WatermarkDisplayContentSettings](Value_Camera_Struct_WatermarkDisplayContentSettings.md)
...
|  |  |
| --- | --- |
| [LonLatFormat](../../Components/IKeyManager/DJIValue.md#value_common_enum_lonlatformat) | *Return the display format of the latitude and longitude in the watermark.* |
...
|  |  |
| --- | --- |
| [LonLatFormat](../../Components/IKeyManager/DJIValue.md#value_common_enum_lonlatformat) lonLatFormat | *The display format of the latitude and longitude in the watermark.* |
...
|  |  |
| --- | --- |
| [LengthUnit](../../Components/IKeyManager/DJIValue.md#value_common_enum_lengthunit) | *Returns the display unit for height in the watermark.* |
...
|  |  |
| --- | --- |
| [LengthUnit](../../Components/IKeyManager/DJIValue.md#value_common_enum_lengthunit) lengthUnit | *The display unit for height in the watermark.* |
...
|  |  |
| --- | --- |
| [ControlLocation](../../Components/IKeyManager/DJIValue.md#value_common_enum_controllocation) | *Return where the watermark is displayed on the camera screen.* |
...
|  |  |
| --- | --- |
| [ControlLocation](../../Components/IKeyManager/DJIValue.md#value_common_enum_controllocation) screenLocation | *Where the watermark is displayed on the camera screen.* |
