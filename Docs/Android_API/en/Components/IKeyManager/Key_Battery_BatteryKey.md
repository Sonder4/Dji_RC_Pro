**Navigation:** [IKeyManager](IKeyManager.md) > [DJIKey<T>](DJIKey.md) > [BatteryKey](Key_Battery_BatteryKey.md)
...
[KeyBatteryHighVoltageStorageTime](#key_battery_batteryhighvoltagestoragesec_inline)
