**Navigation:** [IKeyManager](IKeyManager.md) > [DJIValue](DJIValue.md) > [CameraWatermarkSettings](Value_Camera_Struct_CameraWatermarkSettings.md)
...
[getEnabledForPhotos](#value_camera_struct_camerawatermarksettings_getenabledforphotos_inline)
...
`true` means that watermark information is generated in the photo.
...
[setEnabledForPhotos](#value_camera_struct_camerawatermarksettings_setenabledforphotos_inline)
...
[getEnabledForVideos](#value_camera_struct_camerawatermarksettings_getenabledforvideos_inline)
...
`true` means that watermark information is generated in the video.
...
[setEnabledForVideos](#value_camera_struct_camerawatermarksettings_setenabledforvideos_inline)
