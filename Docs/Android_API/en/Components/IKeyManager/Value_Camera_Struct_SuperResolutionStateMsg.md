**Navigation:** [IKeyManager](IKeyManager.md) > [DJIValue](DJIValue.md) > [SuperResolutionInfo](Value_Camera_Struct_SuperResolutionStateMsg.md)
...
|  |  |
| --- | --- |
| [DoubleRect4Sides](../../Components/IKeyManager/Value_Common_Struct_RectF.md#value_common_struct_rectf) | *Return the maximum area of super resolution photo shooting. (0,0) is the upper left corner of the video interface, (1,1) is the lower right corner of the video interface.* |
...
|  |  |
| --- | --- |
| [DoubleRect4Sides](../../Components/IKeyManager/Value_Common_Struct_RectF.md#value_common_struct_rectf) | *Return the currently set area of super resolution photo shooting. (0,0) is the upper left corner of the video interface, (1,1) is the lower right corner of the video interface.* |
...
|  |  |
| --- | --- |
| [SuperResolutionState](../../Components/IKeyManager/DJIValue.md#value_camera_enum_superresolutionstatus) | *Return the status of super resolution photo shooting.* |
