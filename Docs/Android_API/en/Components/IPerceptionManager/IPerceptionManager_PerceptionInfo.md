**Navigation:** [IPerceptionManager](IPerceptionManager.md) > [PerceptionInfo](IPerceptionManager_PerceptionInfo.md)
...
perception information，includes the switch status of obstacle avoidance, braking distance and warning distance. `Supported since MSDK 5.0.0`
...
[getUpwardObstacleAvoidanceWorking](#iperceptionmanager_perceptioninfo_getupwardobstacleavoidanceworking_inline)
...
[getDownwardObstacleAvoidanceWorking](#iperceptionmanager_perceptioninfo_getdownwardobstacleavoidanceworking_inline)
...
[getLeftSideObstacleAvoidanceWorking](#iperceptionmanager_perceptioninfo_getleftsideobstacleavoidanceworking_inline)
...
[getRightSideObstacleAvoidanceWorking](#iperceptionmanager_perceptioninfo_getrightsideobstacleavoidanceworking_inline)
...
[getForwardObstacleAvoidanceWorking](#iperceptionmanager_perceptioninfo_getforwardobstacleavoidanceworking_inline)
...
[getBackwardObstacleAvoidanceWorking](#iperceptionmanager_perceptioninfo_getbackwardobstacleavoidanceworking_inline)
...
[isUpwardObstacleAvoidanceEnabled](#iperceptionmanager_perceptioninfo_isupwardobstacleavoidanceenabled_inline)
...
[isDownwardObstacleAvoidanceEnabled](#iperceptionmanager_perceptioninfo_isdownwardobstacleavoidanceenabled_inline)
...
[isHorizontalObstacleAvoidanceEnabled](#iperceptionmanager_perceptioninfo_ishorizontalobstacleavoidanceenabled_inline)
...
[getUpwardObstacleAvoidanceWarningDistance](#iperceptionmanager_perceptioninfo_getupwardobstacleavoidancewarningdistance_inline)
...
[getDownwardObstacleAvoidanceWarningDistance](#iperceptionmanager_perceptioninfo_getdownwardobstacleavoidancewarningdistance_inline)
...
[getHorizontalObstacleAvoidanceWarningDistance](#iperceptionmanager_perceptioninfo_gethorizontalobstacleavoidancewarningdistance_inline)
...
[getUpwardObstacleAvoidanceBrakingDistance](#iperceptionmanager_perceptioninfo_getupwardobstacleavoidancebrakingdistance_inline)
...
[getDownwardObstacleAvoidanceBrakingDistance](#iperceptionmanager_perceptioninfo_getdownwardobstacleavoidancebrakingdistance_inline)
...
[getHorizontalObstacleAvoidanceBrakingDistance](#iperceptionmanager_perceptioninfo_gethorizontalobstacleavoidancebrakingdistance_inline)
...
[isVisionPositioningEnabled](#iperceptionmanager_perceptioninfo_isvisionpositioningenabled_inline)
...
[isPrecisionLandingEnabled](#iperceptionmanager_perceptioninfo_isprecisionlandingenabled_inline)
...
[isOverallObstacleAvoidanceEnabled](#iperceptionmanager_perceptioninfo_isoverallobstacleavoidanceenabled_inline)
...
Get whether the main switch of obstacle avoidance is turned on. **Note: This interface has been deprecated since MSDK 5.1.0. Please call `getObstacleAvoidanceType` to get whether the obstacle avoidance switch is enabled. For millimeter wave radar accessories, you need to call `getObstacleAvoidanceEnabled` to get whether the obstacle avoidance switch is enabled.**
