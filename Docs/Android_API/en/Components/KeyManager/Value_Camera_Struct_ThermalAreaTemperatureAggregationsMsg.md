...
|  |
| --- |
| ``` class ThermalAreaTemperatureAggregations implements DJIValue, JNIProguardKeepTag, ByteStream ``` |
...
To get the average temperature measured in current area.

##### Return:

|  |  |
| --- | --- |
| Double | *Returns the average temperature measured in current area.* |
...
To get the minimum temperature measured in current area.

##### Return:

|  |  |
| --- | --- |
| Double | *Return the minimum temperature measured in current area.* |
...
To get the position of the minimum temperature measured in current area.

##### Return:

|  |  |
| --- | --- |
| DoublePoint2D | *Return the position of the minimum temperature measured in current area.* |
...
To get the maximum temperature measured in current area.

##### Return:

|  |  |
| --- | --- |
| Double | *Return the maximum temperature measured in current area.* |
...
To get the position of the maximum temperature measured in current area.

##### Return:

|  |  |
| --- | --- |
| DoublePoint2D | *Return the position of the maximum temperature measured in current area.* |
