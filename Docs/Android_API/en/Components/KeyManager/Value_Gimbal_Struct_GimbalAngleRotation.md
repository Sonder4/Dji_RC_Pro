...
Define setting information about rotation of gimbal angle mode. The body coordinate system of gimbal is used here.
...
|  |  |
| --- | --- |
| [GimbalAngleRotationMode](../../Components/KeyManager/DJIValue.md#value_gimbal_enum_gimbalanglerotationmode) | *Gimbal Angle Rotation Mode* |
...
Set gimbal angle rotation mode.

##### Input Parameters:

|  |  |
| --- | --- |
| [GimbalAngleRotationMode](../../Components/KeyManager/DJIValue.md#value_gimbal_enum_gimbalanglerotationmode) mode | *Gimbal angle rotation mode.* |
...
Get pitch angle of gimbla rotation.
...
Set pitch angle of gimbal rotation. Positive number is rotated upward, while negative number is rotated downward. Please setting referring: `getPitch`.
...
Get yaw angle of gimbal rotation.
...
Set yaw angle of gimbal rotation. Positive number is rotated right, while negative number is rotated left. Please setting referring: `getYaw`.
...
Set roll angle of gimbal rotation. Positive number is rotated right, while negative number is rotated left. Please refer to `getRoll` to set.
...
Set the time of gimbal rotation operation, which does not take effect in waypoint mission.
