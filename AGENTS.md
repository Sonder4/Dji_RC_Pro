...
<description>Convert HTML documentation to GitHub-flavored Markdown. Use this skill to convert local HTML API documentation files into Markdown for easier reading and processing.</description>
<location>project</location>
</skill>
...
<description>"Kotlin 2.0+ development specialist covering Ktor, coroutines, Compose Multiplatform, and Kotlin-idiomatic patterns. Use when building Kotlin server apps, Android apps, or multiplatform projects."</description>
<location>project</location>
</skill>
